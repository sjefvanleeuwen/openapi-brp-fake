...
namespace openapi_brp_fake.Metrics
{
public static class Registry
    {
        public static TimerOptions RaadpleegIngeschrevenPersoonNAWTimer => new TimerOptions
        {
            Name = "RaadpleegIngeschrevenPersoonNAW",
