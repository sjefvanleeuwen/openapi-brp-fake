...
using System.IO;
using System.Linq;
using openapi_brp_fake.Metrics;
using App.Metrics;
...
{ 
    ...
    public class DefaultApiController : Controller
    {
        ...
        public DefaultApiController(IMetrics metrics){
            Metrics = metrics;
        }
        ...
        { 
            using (Metrics.Measure.Timer.Time(Registry.RaadpleegIngeschrevenPersoonNAWTimer))
            {
